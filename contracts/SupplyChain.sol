...
contract SupplyChain {
    ...
    */
    ...
    modifier isOwner() {require (msg.sender == owner, "Sender must be owner"); _;}
    modifier verifyCaller (address _address) {require (msg.sender == _address, "Sender must be the given address"); _;}

    modifier paidEnough(uint _price) {require(msg.value >= _price, "You need to pay the price of the item"); _;}
    ...
    modifier forSale(uint _sku) {require(items[_sku].state == State.ForSale, "Item must be ForSale"); _;}
